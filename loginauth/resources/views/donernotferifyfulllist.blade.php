          ...
          <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="{{asset('uploads/image/'.$doner->id_proof)}}"><img id="" src="{{secure_asset('uploads/image/'.$doner->id_proof)}}" alt="Id Proof" style="width:100px;max-width:300px"></a></td>
                  <td>
                      @if ($doner->verify)
                          <a href="/verifydoner/{{$doner->id}}"  class="btn btn-secondary mt-2 disabled">Verify</a>
                      @else
                          <a href="/verifydoner/{{$doner->id}}" class="btn btn-primary mt-2">Verify</a>
                      @endif
                      <a href="/updatelistdoner/{{$doner->id}}" class="btn btn-primary mt-2">Update</a>
                      <a href="/deletelistdoner/{{$doner->id}}" class="btn btn-primary mt-2">Delete</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
