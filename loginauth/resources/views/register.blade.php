	...
	<div class="row">
				<form action="/save" method="POST" enctype="multipart/form-data">
					...
					<div class="col-sm-12">
						<div class="row">
                            ...
                            <div class="col-sm-6 form-group">
								...
								<input type="text" name="blood_group" placeholder="Enter Blood Group Here.." class="form-control">
							</div>
						</div>						
						<div class="row">
					...
					<div class="form-group">
						...
						<input type="text" name="mobile" placeholder="Enter Mobile Number Here.." class="form-control">
					</div>		
					<div class="form-group">
